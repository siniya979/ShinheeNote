...
> 
> 이런 문제점을 해결하기 위해 의존성 역전을 사용한다. 의존성 역전 관계를 만들면 외부 리소스를 Mock 으로 대체할 수 있다. Mock 으로 대체한다는 것은 외부 리소스의 의존성 주입이 필요없다는 것을 의미하며 또한 외부 리소스의 로직이 잘못되었다 한 들 테스트 하고자 하는 클래스의 로직에는 영향을 주지 않는다. 
> 
> 
